...
if (!isset($_SESSION['user'])) {
    return header('Location: http://wirendi.amisbudi.cloud/web-porto/si-admin/views/Login/' );
}
?>
<!doctype html>
<html lang="en">
  ...
  <body>
    ...
    $(document).ready(function() {
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == "Add"){
                ...
                $.ajax({
                    url:"https://wirendi.amisbudi.cloud/web-porto/si-admin/api/users/create.php",
                    method:"POST",
                ...
                $.ajax({
                    url:"https://wirendi.amisbudi.cloud/web-porto/si-admin/api/users/update.php",
                    method:"PUT",
                    data: JSON.stringify(formData),
                    success:function(data){
                        $('#action_button').attr('disabled', false);
    ...
    function showAll() {
        $.ajax({
            ...
            url:"https://wirendi.amisbudi.cloud/web-porto/si-admin/api/users/read.php",
    ...
    function showOne(id) {
        ...
        $.ajax({
            ...
            contentType: "application/json",
            url:
            "https://wirendi.amisbudi.cloud/web-porto/si-admin/api/users/read.php?id="+id,
            success: function(response) {
                $('#id').val(response.id);
