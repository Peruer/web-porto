...
if (!isset($_SESSION['user'])) {
    return header('Location: http://amisbudi.cloud/web-porto/si-admin/views/Login/' );
}
?>
<!doctype html>
<html lang="en">
  ...
  <body>
    ...
    $(document).ready(function() {
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == "Add"){
                ...
                $.ajax({
                    url:"https://amisbudi.cloud/web-porto/si-admin/api/users/create.php",
                    method:"POST",
                ...
                $.ajax({
                    url:"https://amisbudi.cloud/web-porto/si-admin/api/users/update.php",
                    method:"PUT",
                    data: JSON.stringify(formData),
                    success:function(data){
                        $('#action_button').attr('disabled', false);
    ...
    function showAll() {
        $.ajax({
            ...
            url:"https://amisbudi.cloud/web-porto/si-admin/api/users/read.php",
    ...
    function showOne(id) {
        ...
        $.ajax({
            ...
            contentType: "application/json",
            url:
            "https://amisbudi.cloud/web-porto/si-admin/api/users/read.php?id="+id,
            success: function(response) {
                $('#id').val(response.id);
    ...
    function deleteOne(id) {
        ...
        $.ajax({
            url:"https://amisbudi.cloud:81/konterku/api/user/delete.php",
            method:"DELETE",
